...
export default async function handler(req, res) {
  ...
  try {
    ...
    const kind = (type === "boussole") ? "boussole" : (type === "miroir") ? "miroir" : (type === "aura") ? "aura" : (type === "feuille") ? "feuille" : "sentinelle";
    const folder = (kind === "boussole") ? "boussoles" : (kind === "miroir") ? "miroirs" : (kind === "aura") ? "auras" : (kind === "feuille") ? "feuilles" : "fiches";
