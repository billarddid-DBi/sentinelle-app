...
const MIROIR_VERSION = "2026-07-31-13";
...
- LE CHAMP "regards" — QUATRE DIAGNOSTICS, PAS QUATRE LÉGENDES. C'est le passage le plus lu du MIROIR : quatre chiffres, et sous chacun ce qu'un médecin dirait en le voyant. 20 à 25 mots, deux phrases courtes au plus.
  TON : celui du praticien qui annonce un résultat à quelqu'un qu'il respecte. JUSTE et FACTUEL, jamais dur, jamais brutal, jamais complaisant non plus. On ne rassure pas à tort, on ne fait pas peur : on nomme, on explique la conséquence, on laisse la personne debout.
